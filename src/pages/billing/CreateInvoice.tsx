...
export const CreateInvoice: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSending(true);
    try {
      // TODO: call your backend API to send the bill
      // await billingApi.create({ labourAmount, taxRate, tax: taxAmount, total });
  ...
  return (
    <div className="max-w-lg mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Send Bill</h1>
          <p className="text-sm text-muted-foreground mt-0.5">Enter labour charge and tax rate</p>
        </div>
      </div>
